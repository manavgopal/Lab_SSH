...
def about(request):
    return HttpResponse("""<h1>About Us:</h1><p>With us, you can easily find the music of your choice and easily share it with other people. You can also browse through the collections of friends, artists, and celebrities, or create a playlist of your own.
      Soundtrack your life with us. Subscribe or listen for free.</p>""")

def playlist(request,id):
    # TODO: Complete this method and map it to the URL that takes id, i.e. localhost:8000/playlist/<id>
